public class Constants {
	...
	public static readonly short CMSG_UPDATE_POS = 105;
	public static readonly short SMSG_UPDATE_POS = 205;
	public static readonly short CMSG_DEAL_DMG = 106;
	public static readonly short SMSG_DEAL_DMG = 206;
	public static readonly short CMSG_UPDATE_INV = 107;
	public static readonly short SMSG_UPDATE_INV = 207;
	public static readonly short CMSG_PAUSE = 108;
	public static readonly short SMSG_PAUSE = 208;
	// Other
