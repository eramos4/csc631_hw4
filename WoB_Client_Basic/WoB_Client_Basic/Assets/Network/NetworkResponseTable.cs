...
public class NetworkResponseTable {
	...
	public static void init() {
		...
		add(Constants.SMSG_UPDATE_POS, "ResponsePosition"); //= 205;
		
		add(Constants.SMSG_DEAL_DMG,"ResponseDealtDamage"); //= 206;
		
		add(Constants.SMSG_UPDATE_INV,"ResponseInventory"); //= 207;
		
		add(Constants.SMSG_PAUSE,"ResponsePause"); //= 208;
}
