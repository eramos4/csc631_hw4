...
public class NetworkRequestTable {
	...
	public static void init() {
		...
		add(Constants.CMSG_UPDATE_POS, "RequestPosition"); //= 105;
		add(Constants.CMSG_DEAL_DMG,"RequestDealtDamage"); //= 106;
		add(Constants.CMSG_UPDATE_INV,"RequestInventory"); //= 107;
		add(Constants.CMSG_PAUSE,"RequestPause"); //= 108;
	}
